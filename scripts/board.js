...
function showApiSubtaskToEdit(subtask) {
    return `
      <div class="edit-subtask-container">
        ...
        <div class="delete-or-done-edit">
          <div class="delete-edit-svg">
            <svg onclick="deleteEditedSubtask(${subtask})" width="24" height="24" viewBox="0 0 25 24" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <div class="done-edit-svg">
            <svg onclick="keepEditedSubtask(${subtask})" width="24" height="24" viewBox="0 0 25 24" fill="none" xmlns="http://www.w3.org/2000/svg">
